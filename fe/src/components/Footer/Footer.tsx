...
const Footer: React.FC = () => {
  return (
    <footer
      className="bg-[url(images/newBgFooter.jpg)] text-white text-sm pt-8 pb-4 px-4 md:px-8 bg-no-repeat bg-[#22376f]"
    ...
    >
      <div className="max-w-screen-xl mx-auto grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-6">
        ...
        <div className="md:col-span-1 lg:col-span-1 bg-white text-black p-3 rounded-lg shadow-md flex flex-col items-center">
        ...
        <div className="md:col-span-3 lg:col-span-1">
          ...
          <div className="flex space-x-3 text-xl">
            <div className="p-3 bg-[#44619D]" style={{ borderRadius: "5px" }}>
              <FaFacebookF className="cursor-pointer hover:text-blue-500" />
            </div>
            <div className="p-3 bg-[#DF4B38]" style={{ borderRadius: "5px" }}>
              <FaGooglePlusG className="cursor-pointer hover:text-red-500" />
            </div>
            <div className="p-3 bg-[#33CCFF]" style={{ borderRadius: "5px" }}>
              {" "}
      ...
      <div className="max-w-screen-xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-6 mt-10 text-sm">
        ...
        <div>
          ...
          <p>
            Website:{" "}
            <a
              href="http://www.phongvemaybay360.com"
      ...
      <div className="text-center mt-8 text-xs text-gray-300">
        © 2025 CÔNG TY CP ĐẦU TƯ THƯƠNG MẠI VÀ PHÁT TRIỂN DỊCH VỤ T.H.D
        <br />
