      ...
      >
        <div className="basis-1/2">
          <h4
            ...
            className="font-bold"
          >
            Quý khách có thể mua vé máy bay bằng các hình thức
          </h4>
          <div>
            <span style={{ fontSize: "0.75rem", color: "#373a3c" }}>
              {" "}
              <span style={{ fontSize: "2.5rem", color: "#373a3c" }}>1</span>
          ...
          <div>
            <span style={{ fontSize: "0.75rem", color: "#373a3c" }}>
              {" "}
              <span style={{ fontSize: "2.5rem", color: "#373a3c" }}>2</span>
              .Qua chat
            </span>
            <div className="ps-4">
              <>
          ...
          <div>
            <span style={{ fontSize: "0.75rem", color: "#373a3c" }}>
              {" "}
              <span style={{ fontSize: "2.5rem", color: "#373a3c" }}>3</span>
          ...
          <div>
            <div>
              <span style={{ fontSize: "0.75rem", color: "#373a3c" }}>
                {" "}
                <span style={{ fontSize: "2.5rem", color: "#373a3c" }}>4</span>
                .Đến trực tiếp văn phòng Vebayre247 tại Hà Nội và{" "}
                <Link className="text-blue-600" to={"/lien-he"}>
                  các tỉnh thành khác
                </Link>
              </span>
            </div>
            <iframe
              src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d14925.669039569635!2d105.7694039!3d20.7338753!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x313435575e36e7ab%3A0xe61b6050ae23a69b!2zxJAuIFF1YW5nIFRydW5nLCB0dC4gVsOibiDEkMOsbmgsIOG7qG5nIEjDsmEsIEjDoCBO4buZaSwgVmlldG5hbQ!5e0!3m2!1sen!2s!4v1749463423100!5m2!1sen!2s"
              width="448"
              height="150"
              style={{ border: 0 }}
        ...
        <div className="basis-1/2">
          ...
          <div
            className="flex gap-1 mb-4 py-2"
            style={{ borderBottom: "1px solid #f3f5f5" }}
          >
            <div>
              {" "}
              <img
          ...
          <div className="w-full flex justify-center items-center">
            <img src="images/PartnerV2.jpg" alt="" />
          </div>
        </div>
      </div>
      <div className="flex gap-5">
        ...
        <div
          className="basis-1/2 bg-no-repeat p-[10px]"
          style={{
        ...
        >
          <div
            style={{ fontSize: "1.5rem", color: "#130A7F" }}
            className="font-bold pb-5 pt-3 mb-8"
          >
            Câu hỏi thường gặp
          </div>
          <div>
            <Link
              ...
              style={{ fontSize: "0.75rem" }}
            >
              {">>"} Số lượng Trẻ em, Trẻ nhỏ được chấp nhận đi cùng một người
              lớn.!
            </Link>
          </div>
          <div>
            <Link
              ...
              style={{ fontSize: "0.75rem" }}
            >
              {">>"} Điều gì xảy ra nếu điện thoại không chuyển ‘airplane mode’
              khi bay?
            </Link>
          </div>
          <div>
          ...
          <div>
            <Link
              ...
              style={{ fontSize: "0.75rem" }}
            >
              {">>"} Quy định về hành lý kí gửi của Vietjet Air
            </Link>
          </div>
          <div>
            <Link
              ...
              style={{ fontSize: "0.75rem" }}
            >
              {">>"} Chính sách hỗ trợ đối với hành khách đến làm thủ tục trễ
              tại sân bay.
            </Link>
          </div>
          <div>
            <Link
              ...
              style={{ fontSize: "0.75rem" }}
            >
              {">>"} Hành khách có được mang theo vật nuôi lên máy bay hay
              không?
            </Link>
          </div>
          <div>
            <Link
              ...
              style={{ fontSize: "0.75rem" }}
            >
              {">>"} 51 quốc gia, vùng lãnh thổ công dân Việt Nam du lịch không
              cần Visa
            </Link>
          </div>
          <div>
            <Link
              ...
              style={{ fontSize: "0.75rem" }}
            >
              {">>"} Những vật dụng không được mang theo trong hành lý ký gửi?
            </Link>
          </div>
          <div>
            <Link
              ...
              style={{ fontSize: "0.75rem" }}
            >
              {">>"} 7 mẹo để có một chuyến du lịch suôn sẻ.
            </Link>
          </div>
          <div>
            <Link
