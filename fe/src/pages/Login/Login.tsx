...
export default function LoginForm() {
  ...
  const onSubmit = async (data: FormData) => {
    ...
    try {
      ...
      dispatch(
        setUser({ ...response.data, accessToken: response.data.access_token }),
      );
    } catch (error: any) {
    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50">
      <div className="bg-white p-8 w-full max-w-md shadow-2xl rounded-2xl border border-gray-100">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-2xl font-bold text-gray-800 mb-2">Chào mừng</h1>
          ...
          <div className="space-y-2">
            ...
            <div className="relative">
              <input
                ...
                className={`w-full px-4 py-3 pl-11 border rounded-lg focus:outline-none focus:ring-2 transition-all duration-200 ${
                  errors.userName
          ...
          <div className="space-y-2">
            ...
            <div className="relative">
              <input
                ...
                className={`w-full px-4 py-3 pl-11 pr-11 border rounded-lg focus:outline-none focus:ring-2 transition-all duration-200 ${
                  errors.password
                    ? "border-red-300 focus:ring-red-500 focus:border-red-500"
                    : "border-gray-300 focus:ring-blue-500 focus:border-blue-500"
                }`}
