...
import RequestDialog, {
  type IRequestFormInputs,
} from "../../components/dialogRequest/DialogRequest";
...
const RequestManagement: React.FC = () => {
  ...
  const handleSubmitAdd = async (data: IRequestFormInputs) => {
    try {
      ...
      setSnackbar({
        open: true,
        message: "Thất bại đã tồn tại yêu cầu hoặc mã đơn đã tồn tại",
        severity: "error",
      });
    }
  };
  ...
  return (
    <Box sx={{ p: 3 }}>
      ...
      <Box sx={{ mb: 3 }}>
        <Typography
          variant="h4"
          sx={{ fontWeight: "bold", mb: 1, color: "#1a1a2e" }}
        >
          Quản lý yêu cầu
        </Typography>
