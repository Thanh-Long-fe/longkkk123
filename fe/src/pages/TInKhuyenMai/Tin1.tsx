...
const UuDaiHe2024 = () => {
  const article: any = promotions.find(
    (item) =>
      item.link === "/uu-dai-he-2024-dat-ve-may-bay-tang-ngay-chang-xe-vip",
  );
    ...
    <div className="p-4">
      <div className="breadcrumb breadcrumbs">
        <div className="rdfa-breadcrumb">
          <div>
            ...
            <Link to="/tin-khuyen-mai">Tin Khuyến Mại</Link>
      ...
      <article className="mt-4">
        ...
        <p>
          ...
          hành trình hãy cập nhật ngay để nhận được hỗ trợ nhanh chóng.
        </p>
        <p>
          <strong>BAY.VN</strong> chúc các bạn có những chuyến đi hoàn hảo trong
          mùa hè năm nay!
        </p>
      </article>
    </div>
