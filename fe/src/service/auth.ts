...
export const updateUser = (id: string, params: { userName: string, password: string, name: string, image?: string, role?: string, status: string}) => {
  return axiosInstance.put(`/user/update/${id}`, {...params})
}
export const getListUser = () => {
  return axiosInstance.get('/user/list')
}
export const register = (params: { userName: string, password: string, name: string, image?: string, role?: string, status: string}) => {
